...
func main() {
	...
	// go job.NewSpotJob(channel.CurrencyPairMAPE_USDT, 50, 0.002, channel.SecondKey, channel.SecondSecret).Start()
	go job.NewSpotJob(channel.CurrencyPairVGX_USDT, 65, 0.003, channel.SecondKey, channel.SecondSecret).Start()
