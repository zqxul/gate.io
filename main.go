...
func main() {
	...
	go job.New(channel.CurrencyPairXRP_USDT, decimal.NewFromFloat(50), decimal.NewFromFloat(0.0015), channel.SecondKey, channel.SecondSecret).Start()
	go job.New(channel.CurrencyPairDOGE_USDT, decimal.NewFromFloat(50), decimal.NewFromFloat(0.003), channel.SecondKey, channel.SecondSecret).Start()
